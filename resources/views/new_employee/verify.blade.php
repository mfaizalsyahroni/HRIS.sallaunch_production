...
@section('content')
    ...
    <div class="container d-flex flex-column align-items-center justify-content-start min-vh-100 pt-5"
        style="background: url('{{ asset('img/home/ne.png') }}') no-repeat center; background-size: 600px;">
        ...
        <div class="card shadow bg-white bg-opacity-75 mb-3" style="width: 400px; margin-top: 50px;">
            <div class="card-body p-4 rounded">
                ...
                <form action="{{ route('new_employee.verifyWorker') }}" method="POST" autocomplete="off">
                    @csrf
                    <div class="mb-3">
        ...
        <div class="d-flex justify-content-center align-item-center py-4">
            <form action="{{ route('new_employee.logout') }}" method="POST">
                @csrf
                <button type="submit" class="btn btn-danger w-100 px-4 fw-bold">
