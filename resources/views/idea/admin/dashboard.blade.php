        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <div class="progress" style="height:25px">
                    ...
                    <div class="progress-bar bg-secondary" style="width: {{ $totalIdeas ? ($draft / $totalIdeas) * 100 : 0 }}%">
                        Draft
                    </div>

                    <div class="progress-bar bg-warning" style="width: {{ $totalIdeas ? ($voting / $totalIdeas) * 100 : 0 }}%">
                        Voting
                    </div>
